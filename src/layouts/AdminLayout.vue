<template>
  <a-layout :class="['admin-layout', 'beauty-scroll']">
    ...
    <a-layout class="admin-layout-main beauty-scroll">
      ...
      <a-layout-header v-show="fixedHeader" :class="['virtual-header', {'fixed-tabs' : fixedTabs, 'fixed-header': fixedHeader, 'multi-page': multiPage}]"></a-layout-header>
...
export default {
  name: 'AdminLayout',
  components: { SideMenu, Drawer, PageFooter, AdminHeader, Setting },
  data() {
    return {
